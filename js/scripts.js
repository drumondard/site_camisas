...
$(function(){
    ...
    function atualizar_orcamento(parametros) {
        ...
        window.setTimeout(function(){  
            ...
            // $('#result_gola').html(parametros.gola);                   // não busca o formato HTML
            // $('#result_estampa').html(parametros.estampa);             // não busca o formato HTML
            // $('#result_qualidade').html(parametros.qualidade);         // não busca o formato HTML
            // $('#result_cor').html(parametros.cor);                    // não busca o formato HTML
            // $('#result_embalagem').html(parametros.embalagem);        // não busca o formato HTML
...
$('#quantidade').change(function(){
    ...
    // Ao carregar a página verificando localStorage

    if (window.localStorage["quantidade"]) {
        parametros_pesquisa.qualidade = (window.localStorage["quantidade"]);
    }
